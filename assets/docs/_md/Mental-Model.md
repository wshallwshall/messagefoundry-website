...
*Open-source healthcare integration engine · Python · v0.2.1 (Early Access)*
...
- **Install:** the supported production artifact is the signed, version-pinned PyPI wheel (pip install "messagefoundry==0.2.1"); then messagefoundry init scaffolds your own config repo (ADR 0017). Extras are opt-in: \[postgres\], \[sqlserver\], \[console\], \[sftp\].
